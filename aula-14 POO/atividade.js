...
// public: é um metodo e um atributo onde todos podem usar, é acessivel
// private: é acessivel somente dentro da sua propria classe
// protected: acessivel dentro da propria classe e tb dentro da subclasse (herança)
...
//uma forma de proteger os dados
// ● Atividade 2
...
const jorge = new Aluno ()
jorge.setNome('Jorge')
console.log(jorge.getNome())
...
conta.depositar(10)
console.log("meu saldo é: ", conta.getExtrato())
...
const senhaMassa = new Login()
senhaMassa.setSenha(123)
console.log(senhaMassa.getSenha())